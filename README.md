...
- [x] Категории (CRUD + seed дерева)
- [x] Объявления (CRUD, редактирование, проверка владельца)
- [x] Загрузка фото (обложка, галерея)
- [x] Каталог: поиск, фильтры, сортировка, пагинация
- [x] Избранное
